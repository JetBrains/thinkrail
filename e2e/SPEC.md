...
native `/name` path, open-tab and closed-history inline rename paths, and reload durability without
involving a provider. Questionnaire paging uses a canonical persisted tool-call/ack
