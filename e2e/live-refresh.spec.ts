...
test("worktree changes on disk appear live in Specs, All files, Changes, and an open file tab", async ({
	...
	// --- Changes: a tracked-file edit surfaces while the tab is open, and an opened diff tab follows
	// further edits (DiffPane re-fetches its two sides on the fs tick).
