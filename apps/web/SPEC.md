...
| `nativeUpdates` | optional native update capability, local controller, and shared update presentation | yes | [nativeUpdates/SPEC.md](src/nativeUpdates/SPEC.md) |
