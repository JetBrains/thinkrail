...
export function CodeBlock({ code, lang }: { code: string; lang: string }) {
	...
	if (html === null) {
		return (
			<pre className="overflow-auto rounded-[var(--radius-sm)] bg-bg-dark p-sm text-mono text-text">
				{code}
			</pre>
		);
	}
	return (
		<div
			className="overflow-auto rounded-[var(--radius-sm)] text-mono [&_pre]:!m-0 [&_pre]:!bg-bg-dark [&_pre]:p-sm"
