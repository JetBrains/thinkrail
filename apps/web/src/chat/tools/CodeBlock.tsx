...
export function CodeBlock({ code, lang }: { code: string; lang: string }) {
	...
	if (html === null) {
		return (
			<pre className="overflow-auto rounded-[var(--radius-sm)] bg-container-terminal-bg p-sm font-[var(--font-mono)] text-text-default text-xs">
				{code}
			</pre>
		);
	}
	return (
		<div
			className="overflow-auto rounded-[var(--radius-sm)] text-xs [&_pre]:!m-0 [&_pre]:!bg-container-terminal-bg [&_pre]:p-sm"
