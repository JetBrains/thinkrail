...
export function PanZoomView({ svg }: { svg: string }) {
	...
	return (
		<div className="relative min-h-0 flex-1">
			...
			/>
			<div className="absolute right-sm bottom-sm flex items-center gap-xs rounded-[var(--radius-sm)] border border-border-default bg-container-popover-bg p-1 tr-text-metadata shadow-[var(--shadow-lg)]">
				<button
					type="button"
					aria-label="Zoom out"
