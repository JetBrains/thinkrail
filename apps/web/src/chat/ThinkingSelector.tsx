	...
	return (
		<Popover open={open} onOpenChange={setOpen}>
			<PopoverTrigger
				...
				className="flex h-8 items-center gap-sm rounded-[var(--radius-md)] border border-control-border bg-clip-padding bg-control-bg px-sm tr-text-ui text-text-default outline-none transition-colors hover:bg-control-bg-hovered focus-visible:ring-2 focus-visible:ring-primary disabled:bg-control-disabled-bg disabled:text-control-disabled-text data-[open=true]:border-primary-strong data-[open=true]:bg-control-bg-selected"
			>
