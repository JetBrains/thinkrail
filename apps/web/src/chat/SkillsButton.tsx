...
export function SkillsButton({
	...
	return (
		<button
			...
			className={cn(
				"flex shrink-0 items-center gap-xs rounded-[var(--radius-sm)] px-sm py-0.5 text-muted text-xs outline-none transition-colors hover:bg-hover hover:text-text-default focus-visible:ring-2 focus-visible:ring-primary",
				className,
			)}
		>
