...
function ScopeOption({
	...
	return (
		<button
			...
			onClick={onSelect}
			className={cn(
				"flex-1 rounded-[var(--radius-md)] border px-12 py-8 text-left tr-text-ui outline-none transition-colors focus-visible:ring-2 focus-visible:ring-primary disabled:cursor-not-allowed disabled:bg-control-disabled-bg disabled:text-control-disabled-text",
				active
