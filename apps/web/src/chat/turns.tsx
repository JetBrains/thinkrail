...
export function ChatTurnView({
	...
	switch (row.kind) {
		...
		case "markdown":
			return (
				<div data-testid="chat-message" data-role="assistant" className="text-base text-text">
...
function UserTurn({ message }: { message: UserMessage }) {
	return (
		<div data-testid="chat-message" data-role="user" className="flex justify-end">
			<div className="max-w-[85%] whitespace-pre-wrap rounded-[var(--radius-md)] border border-[var(--bubble-user-border)] bg-[var(--bubble-user-bg)] px-md py-sm text-base text-text">
