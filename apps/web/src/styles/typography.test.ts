				...
				chat: {
					...Object.fromEntries(
						Object.keys(PROSE_SELECTORS).map((id) => [
							id,
							{
								$ref: id === "inlineCode" || id === "codeBlock" ? "code.inline" : "probe.base",
							},
						]),
					),
					...prose,
