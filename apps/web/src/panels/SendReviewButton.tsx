...
function SendButtonBase({
	...
	return (
		<button
			...
			disabled={busy}
			onClick={() => void run()}
			className="flex h-6 shrink-0 items-center gap-xs rounded-[var(--radius-md)] bg-control-primary-bg px-sm text-control-primary-text tr-text-action transition-colors hover:bg-control-primary-bg-hovered disabled:bg-control-primary-disabled-bg disabled:text-control-primary-disabled-text"
		>
