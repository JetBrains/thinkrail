		...
		<li>
			...
			>
				...
				<button
					...
					className="flex h-7 min-w-0 flex-1 items-center gap-sm rounded-[var(--radius-sm)] pr-xs text-left outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-inset"
				>
					<DocumentIcon
						className={cn(
