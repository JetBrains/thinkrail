	...
	return (
		...
		>
			<h1
				...
				className="max-w-[640px] break-words text-brand text-[44px] text-primary leading-tight"
			>
...
const Card = forwardRef<HTMLButtonElement, CardProps>(function Card(
	...
	return (
		...
		>
			{tag ? (
				<span className="absolute top-md right-md rounded-full border border-[var(--primary-40)] bg-[var(--primary-10)] px-sm py-0.5 font-(family-name:--font-mono) text-[10px] text-primary uppercase tracking-wide">
					{tag}
				</span>
			) : null}
			<span
