		...
		<button
			...
			className={cn(
				...
				primary
					...
					: "border-border-default bg-container-workspace-bg hover:border-[var(--primary-40)] hover:bg-elevated",
				className,
			)}
		>
			{tag ? (
			...
			<span
				className={cn(
					...
					primary ? "bg-primary text-on-accent" : "bg-hover text-text-text-muted",
				)}
			>
