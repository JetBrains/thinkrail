	...
	return (
		...
		>
			...
			<div
				...
				className="group flex items-center gap-sm rounded-[var(--radius-md)] border border-border-default bg-[var(--input-bg)] px-md py-sm"
			>
				...
				<div className="flex shrink-0 items-center gap-xs">
					{showOpenAsFile ? (
						<button
							...
							title="Open as file"
							onClick={openAsFile}
							className="flex size-6 items-center justify-center rounded-[var(--radius-sm)] text-text-muted transition hover:bg-container-popover-bg hover:text-text-default"
						>
					...
					<PopoverTrigger asChild>
						<button
							...
							aria-label="Delete"
							title="Delete"
							className="flex size-6 items-center justify-center rounded-[var(--radius-sm)] text-text-muted transition hover:bg-container-popover-bg hover:text-feedback-error"
						>
