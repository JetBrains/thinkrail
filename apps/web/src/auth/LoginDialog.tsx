							...
							<div className="flex flex-col gap-xs">
								...
								<div className="flex gap-sm">
									<input
										...
										className="min-w-0 flex-1 rounded-[var(--radius-md)] border border-control-border-default bg-control-bg px-sm py-xs tr-text-ui text-text-default outline-none placeholder:text-text-muted focus-visible:border-control-border-active"
									/>
