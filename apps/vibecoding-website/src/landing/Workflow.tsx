      ...
      <div className="mx-auto grid max-w-[1200px] items-start gap-12 px-6 py-12 sm:py-24 md:grid-cols-2">
        <Reveal>
          ...
          <Subtitle className="mt-6">
            Before touching code, your agent outlines requirements, dependencies, and expected
            outcomes in a centralized spec file. Once approved, the agent implements tests first to
            verify expected behavior, preventing runaway side effects.
          </Subtitle>
        </Reveal>
        <Reveal delay={90}>
          <CodePanel>
    ...
    <section id="isolation" className="scroll-mt-16 border-b border-border-muted">
      <div className="mx-auto grid max-w-[1200px] items-start gap-12 px-6 py-12 sm:py-24 md:grid-cols-2">
        <Reveal delay={90} className="md:order-2">
          ...
          <Subtitle className="mt-6">
            No more switching branches back and forth. ThinkRail leverages local Git worktrees to
            spawn multiple sandboxed instances. Each agent writes to its own isolated directory,
            preserving your primary development tree completely untouched.
          </Subtitle>
        </Reveal>
