...
const cards = [
  ...
  },
  {
    ...
    body: "Isolated workspaces running safe sandboxed dependencies.",
  },
  {
    n: "03",
  ...
  },
  {
    ...
    body: "Automatic documentation tracking for historical context.",
  },
  {
    n: "06",
    title: "Multi-model runtime",
    body: "Select models dynamically per individual task complexity.",
  },
];
        ...
        <Reveal delay={80}>
          <div className="mt-12 -mr-6 flex snap-x gap-5 overflow-x-auto pr-6 pb-2">
            {cards.map((c) => (
              ...
              >
                <p className="text-[13.2px] tracking-widest text-text-muted">
                  [ {c.n} ]
                </p>
