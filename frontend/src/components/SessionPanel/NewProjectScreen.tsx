    ...
    <div className="np-screen">
        ...
        <div className="np-form">
          ...
          <div className="np-field">
            <div className="np-label">Project name</div>
            <input
          ...
          <div className="np-field">
            <div className="np-label">Goals · what should this project do</div>
            <div className="np-textarea-wrap">
              ...
              {voice.isSupported && (
                <button
                  className={`np-mic${voice.isRecording ? " np-mic--recording" : ""}${voice.isTranscribing ? " np-mic--transcribing" : ""}`}
          ...
          <div className="np-actions">
            <span className="np-hint">
              <span className="np-kbd">⌘</span> <span className="np-kbd">↵</span> to start
            </span>
            <div className="np-actions-buttons">
              <button
                className="np-btn"
              ...
              >
                ...
                <svg className="np-btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" aria-hidden="true">
