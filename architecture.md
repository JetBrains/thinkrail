...
apps/website    public landing page + blog (GitHub Pages)         ── standalone: no workspace deps
apps/vibecoding-website  vibecoder landing (Cloudflare Pages)     ── standalone: no workspace deps
