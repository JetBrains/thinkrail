...
8. **Per-call models are an unpinned-definition fallback.** `Agent.model` lets the parent choose any
   ...
   With neither source set, the core preserves parent-model inheritance.
