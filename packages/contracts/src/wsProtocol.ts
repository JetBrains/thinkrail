...
// v38: `TranscriptMessage` gains the `compactionSummary` role (`WireCompactionMessage`) —
// `session.getMessages` forwards Pi's compaction record and history `messageIndex` slots count it.
