// Public surface of the tools layer: register all six todo tools onto a pi ExtensionAPI. The extension
...
/** Register `todo_list`, `todo_add`, `todo_update`, `todo_remove`, `todo_write`, `todo_plan_summary`. */
